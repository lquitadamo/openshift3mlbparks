...
$ oc create -f https://raw.githubusercontent.com/lquitadamo/openshift3mlbparks/master/mlbparks-template-eap.json
$ oc new-app mlbparks
````
...
````
# oc create -f https://raw.githubusercontent.com/lquitadamo/openshift3mlbparks/master/mlbparks-template-eap.json -n openshift
````
